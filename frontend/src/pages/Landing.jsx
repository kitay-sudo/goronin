...
function TimewebCard() {
  return (
    <div className="mt-10 rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-zinc-900/60 to-zinc-900/40 p-6 md:p-7">
      <div className="flex items-start gap-4">
        <div className="shrink-0 inline-flex items-center justify-center w-12 h-12 rounded-xl border border-emerald-500/40 bg-emerald-500/10 text-emerald-300">
          <Server size={20} />
        </div>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            <a
              ...
              className="text-emerald-300 hover:text-emerald-200 font-medium underline-offset-4 hover:underline"
            >
              Timeweb Cloud
            </a>{' '}
            ...
            и хочешь чтобы GORONIN охранял их без задержек.
          </p>
          ...
          <a
            ...
            target="_blank"
            rel="sponsored noopener"
            className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-zinc-950 transition-colors"
          >
...
const CHANGELOG = [
  {
    version: '0.16.0',
    date: '2026-04-28',
    title: 'Управление heartbeat и health-check с метриками',
    highlights: [
      'Новая команда goronin config — задать watch.heartbeat_hours (частота heartbeat-сообщений в Telegram)',
      'Изменения конфига персистятся и применяются на лету',
      'health-check теперь показывает uptime сервиса и счётчики событий',
      'Покрыто тестами: config + heartbeat-модуль',
    ],
  },
  {
    version: '0.15.0',
    date: '2026-04-28',
    title: 'Health-check: отдельно живые и мёртвые порты',
    highlights: [
      'goronin status / health чётко делит ловушки на alive и dead',
      'Структурированный вывод — видно, какие именно порты не отвечают',
      'Единое форматирование с прошлыми улучшениями вывода',
    ],
  },
];
